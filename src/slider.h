...
namespace facade {
  ...
  void initSlider();
  double slider(std::string id, slider_type type, int w, int l, double min, double max, double val, slider_renderer renderer = nullptr);
  double slider(std::string id, slider_type type, int l, double min, double max, double val, slider_renderer renderer = nullptr);
